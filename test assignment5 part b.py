...
#1.street and the walk signal for pedestrian are at same directions and that traffic light is green
#2.street and the walk signal for pedestrian are at same directions and that traffic light is red
#1.street and the walk signal for pedestrian are not at same directions and that traffic light is green
#1.street and the walk signal for pedestrian are not at same directions and that traffic light is red
...
def test_pedestrian_cross_street():
    ...
    #1. test if traffic light and the walk signal for pedestrian are same direction but that traffic light is red
    ...
    #2. test if traffic light and the walk signal for pedestrian are same direction and that traffic light is green
    ...
    #3.test if traffic light and the walk signal for pedestrian are not same direction and that traffic light is red
